...
public class phone_t {
	...
	public void addPhoneToUser() {
		...
		given().pathParam("companyId", companyA.getId()).contentType(MediaType.APPLICATION_JSON).body(usrA).when()
				.put("/user/{companyId}").then().statusCode(200).body(is("" + companyA.getId()));
		...
		given().pathParam("id", companyA.getId()).contentType(MediaType.APPLICATION_JSON).body(phoneA).when()
				.put("/phone/{id}").then().statusCode(200).body(is("true"));

		response = given().queryParam("usrId", usrA.getId()).contentType(MediaType.APPLICATION_JSON).when()
				.get("/phone");
	...
	public void addPhoneToUserDuplicate() {
		...
		given().pathParam("id", companyA.getId()).contentType(MediaType.APPLICATION_JSON).body(phoneA).when()
				.put("/phone/{id}").then().statusCode(200).body(is("false"));

		Response response = given().queryParam("usrId", usrA.getId()).contentType(MediaType.APPLICATION_JSON).when()
				.get("/phone");
	...
	public void addPhoneToUser2() {
		...
		given().pathParam("id", companyA.getId()).contentType(MediaType.APPLICATION_JSON).body(phoneB).when()
				.put("/phone/{id}").then().statusCode(200).body(is("true"));
	...
	public void addPhoneToUserToMannyNumbers() {
		...
		given().pathParam("id", companyA.getId()).contentType(MediaType.APPLICATION_JSON).body(phoneC).when()
				.put("/phone/{id}").then().statusCode(200).body(is("false"));
	}
	...
	public void getUserPhones() {
		Response res = given().queryParam("usr_id", usrA.getId()).contentType(MediaType.APPLICATION_JSON).when()
				.get("/phone");
	...
	public void removePhoneFromUser() {
		given().contentType(MediaType.APPLICATION_JSON).body(phoneA).when().delete("/phone").then().statusCode(200)
				.body(is("true"));
	}
	...
	public void getUserPhones2() {
		Response res = given().queryParam("number", phoneB.getNumber()).contentType(MediaType.APPLICATION_JSON).when()
				.get("/phone");
	...
	public void updatePhone() {
		...
		given().contentType(MediaType.APPLICATION_JSON).body(phoneB).when().post("/phone").then().statusCode(200)
				.body(is("true"));
	...
	public void removeAllPhoneFromUser() {
		...
		given().contentType(MediaType.APPLICATION_JSON).body(usrC).when().delete("/phone/all").then().statusCode(200)
				.body(is("true"));
	}
